package library.lms.UpdateDeleteMember;
...
public class UpdateDeleteMember extends javax.swing.JFrame {
     ...
     */
    public UpdateDeleteMember() throws Exception {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Delete/Update Member");
        ...
        jLabel1.setText("Enter Member Id First");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(162, 290, Short.MAX_VALUE))
        );
    ...
    private void b3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b3ActionPerformed
        ...
        String insert = "update  member set id ="
                + "'" + id + "',name="
                + "'" + name + "',contact="
                + "'" + contact + "',email="
                + "'" + email + "'where id=" + id + "";
    ...
    private void b1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b1ActionPerformed
        ...
        String insert = "Delete from member where id=" + id + "";
        if (id.equals("") || t2.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Please Fill Currect Id", "Error", HEIGHT);
            ...
            if (dbh.isExeQuery(insert)) {
                ...
                JOptionPane.showMessageDialog(null, "Member Not Deleted", "Error", HEIGHT);
